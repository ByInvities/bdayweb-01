...
import { PixelGiftBox, TwineBow, PixelMushroom, PixelFlower, PixelStar } from '../components/PixelProps';
...
export const OpeningPage: React.FC<OpeningPageProps> = ({ onSelectYes, onSelectNo }) => {
    ...
    <div className="flex-1 flex flex-col items-center justify-center py-6 px-4">
      ...
      >
        ...
        <div className="absolute -top-7 left-1/2 -translate-x-1/2 bg-[#fbf7ee] px-5 py-1.5 rounded-full border-2 border-[#3d2b1f] shadow-[2px_2px_0px_#3d2b1f] flex items-center gap-2">
          ...
          <span className="text-xs font-pixel text-[#3d2b1f] font-semibold">Special Delivery</span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-8 my-4 text-left">
          ...
          >
            <PixelGiftBox className="w-28 h-28 sm:w-36 sm:h-36" color="#d9777f" />
            <motion.div 
        ...
        {/* Yes / No Buttons Styled as Pixel Icons */}
